        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <Card size="small">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">Tin nhắn hôm nay</div>
            </div>
          </Card>
          <Card size="small">
            <div className="text-center">
          ...
          <div style={{ height: "calc(100% - 120px)", overflowY: "auto" }}>
            {loading && rooms.length === 0 ? (
              ...
              <List
                ...
                renderItem={(room) => (
                  <List.Item
                    className={`cursor-pointer rounded-xl hover:bg-slate-800 transition-colors ${
                      selectedRoom?._id === room._id ? "bg-slate-800" : ""
                    }`}
                      ...
                      title={
                        <div className="flex items-center justify-between">
                          <span className="font-semibold">
                            {room.user_id?.full_name || "Unknown"}
                          </span>
                          <Tag
                            color={
                              room.status === "active" ? "green" : "default"
                            }
                            style={{ fontSize: "10px" }}
                          >
                            {room.status === "active" ? "Hoạt động" : "Đã đóng"}
                          </Tag>
                        </div>
                      }
                      description={
                ...
                <div className="flex items-center justify-between">
                  <Space>
                    ...
                    <div>
                      <div className="font-semibold">
                        {selectedRoom.user_id?.full_name}
                      </div>
                  ...
                  {/* <Space>
                    ...
                    {selectedRoom.status === "closed" && (
                      <Button type="primary" onClick={handleReopenRoom}>
                        Mở lại chat
                      </Button>
                    )}
                  </Space> */}
